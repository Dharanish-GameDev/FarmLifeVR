Shader "Custom/BillboardShader"
{
    Properties
    {
        ...
        _TintColor ("Tint Color", Color) = (1, 1, 1, 1) // Tint color property
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            uniform float4 _TintColor; // Uniform for Tint color
            ...
            float4 frag(v2f i) : COLOR
            {
                ...
                return texColor * _TintColor; // Apply tint to the texture
            }
