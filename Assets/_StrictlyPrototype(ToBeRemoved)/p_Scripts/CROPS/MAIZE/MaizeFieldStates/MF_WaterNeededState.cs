...
namespace FARMLIFEVR.CROPS.MAIZE
{
	...
	public class MF_WaterNeededState : MaizeFeildBaseState
	{
        //Constructor
        public MF_WaterNeededState(MaizeFieldContext context, MaizeFieldStateMachine.EMaizeFieldState state) : base(context, state)
        {
        ...
        private readonly MaizeFieldStateMachine.EMaizeFieldState nextState = MaizeFieldStateMachine.EMaizeFieldState.Pest;
