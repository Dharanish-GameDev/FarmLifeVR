...
namespace FARMLIFEVR.CROPS.MAIZE
{
	...
	{
        //Constructor
        public MF_HarvestingState(MaizeFieldContext context, MaizeFieldStateMachine.EMaizeFieldState state) : base(context, state)
        {
        ...
        private readonly MaizeFieldStateMachine.EMaizeFieldState nextState = MaizeFieldStateMachine.EMaizeFieldState.AfterHarvesting;
