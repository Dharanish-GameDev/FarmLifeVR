...
{
	public class MF_MediumPlantState : MaizeFeildBaseState
	{
        //Constructor
        public MF_MediumPlantState(MaizeFieldContext context, MaizeFeildStateMachine.EMaizeFieldState state) : base(context, state)
        {
